...
function ActivateCurrencyModal({ isVisible, onClose }) {
  if (!isVisible) {
    return null;
  }
    ...
    <div className="modalMakePrimary">
      <div className="modal-contentMakePrimary">
        ...
        <div className="modalContentMakePrimaryDiv">
          ...
          <p className="makePrimaryPa">Activate this currency</p>
          ...
          <button className="btnMakePrimary">
            <span className="btnTMakePrimary">Activate Currency</span>
          </button>
        </div>
      </div>
    </div>
