    ...
    <div className="walletContainer">
      <div className="walletContainerDiv1">
        <Link className="linkCard">
          <p className="linkCardIcon">Icon</p>
          <p className="linkCardP">Link a card</p>
        </Link>

        <div className="paypalBal">
          <img scr="" alt="" className="paypalBalImg" />
      ...
      <div className="walletContainerDiv2">
        <img scr="" alt="" className="walletContainerDiv2Img" />
        ...
        <div className="preferred">
          ...
          <p className="preferredP1">
            We'll use your available balance when you shop online or send money
          ...
          <Link className="preferredAbout">More about payment preferences</Link>
        </div>
      </div>
    </div>
  );
